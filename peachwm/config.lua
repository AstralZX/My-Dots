...
effects = {
    windows = {
        corner_radius = 20, -- 0 = off, or a pixel value like 6, 10, 14
        ...
        transparency = {
            ...
            opacity_fullscreen = 0.8,
            opacity_focused = 0.8,
            opacity_unfocused = 0.69,
...
autostart = {
    ...
    "waybar",
    "swaybg -o '*' -i /home/goon/Pictures/kitty.png -m fill &",
...
keybinds = {
    { mods = { "logo" },          key = "enter",   action = "spawn",            args = { "kitty" } },
    ...
    { mods = { "logo" },          key = "p",       action = "spawn",            args = { "python", "/home/goon/.local/bin/selector.py" } },
